...
COMMONAPI_DECLARE_PLUGIN_CREATOR(::commonApi::controllableprocess::ControllableProcess, COMMONAPICONTROLLABLEPROCESS_PLUGIN_CREATOR_NAME, _services);

#define COMMONAPI_DEFINE_CONTROLLABLEPROCESS_PLUGIN_CREATOR(_services)  COMMONAPI_DECLARE_PLUGIN_CREATOR(::commonApi::controllableprocess::ControllableProcess, COMMONAPICONTROLLABLEPROCESS_PLUGIN_CREATOR_NAME, _services)
